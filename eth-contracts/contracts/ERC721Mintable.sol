...
contract Ownable {
    ...
    //  3) create an 'onlyOwner' modifier that throws if called by any account other than the owner.
     modifier onlyOwner() {
        require(msg.sender == _owner, "Require only owner of this contract");
        _;
    }
    ...
    function transferOwnership(address newOwner) public onlyOwner {
        ...
        require(newOwner != address(0), "The new owner must be a real address");
...
//  4) create 'whenNotPaused' & 'paused' modifier that throws in the appropriate situation
    modifier whenNotPaused() {
        require(!_paused, "Contract active");
        _;
    }
    modifier paused() {
...
contract ERC721 is Pausable, ERC165 {
    ...
    function _mint(address to, uint256 tokenId) internal {
        ...
        require(!_exists(tokenId) && to != address(0), "tokenId already exists or given address is invalid");
